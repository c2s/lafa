...
class SeedCategoryAndArticleData extends Migration
{
    ...
    public function up()
    {
        Category::create(['id' => 1, 'name' => '企业新闻', 'parent' => 0, 'path' => '0', 'order' => 0, 'type' => 'article']);
        Category::create(['id' => 2, 'name' => '成功案例', 'parent' => 0, 'path' => '0', 'order' => 1, 'type' => 'article']);
        Category::create(['id' => 3, 'name' => '产品活动', 'parent' => 0, 'path' => '0', 'order' => 2, 'type' => 'article']);
        Category::create(['id' => 4, 'name' => '人才招聘', 'parent' => 0, 'path' => '0', 'order' => 3, 'type' => 'article']);
        ...
        Navigation::create(['id'=>1,'category'=>'desktop','type'=>'action','title'=>'关于我们','target'=>'_self','parent'=>0, 'is_show'=>'1',  'path' => '0', 'order' => 0, 'created_op'=>1, 'updated_op'=>1, 'params'=>'{"route": "company.index", "params": "{}"}']);
        Navigation::create(['id'=>2,'category'=>'desktop','type'=>'article','title'=>'企业新闻','target'=>'_self','parent'=>0, 'is_show'=>'1', 'path' => '0', 'order' => 1, 'created_op'=>1, 'updated_op'=>1, 'params'=>'{"category_id": "1"}']);
        Navigation::create(['id'=>3,'category'=>'desktop','type'=>'article','title'=>'成功案例','target'=>'_self','parent'=>0, 'is_show'=>'1', 'path' => '0', 'order' => 2, 'created_op'=>1, 'updated_op'=>1, 'params'=>'{"category_id": "2"}']);
        Navigation::create(['id'=>4,'category'=>'desktop','type'=>'article','title'=>'产品活动','target'=>'_self','parent'=>0, 'is_show'=>'1', 'path' => '0', 'order' => 3, 'created_op'=>1, 'updated_op'=>1, 'params'=>'{"category_id": "3"}']);
        Navigation::create(['id'=>5,'category'=>'desktop','type'=>'article','title'=>'人才招聘','target'=>'_self','parent'=>0, 'is_show'=>'1', 'path' => '0', 'order' => 4, 'created_op'=>1, 'updated_op'=>1, 'params'=>'{"category_id": "4"}']);
        Navigation::create(['id'=>6,'category'=>'desktop','type'=>'page','title'=>'联系我们','target'=>'_self','parent'=>0, 'is_show'=>'1', 'created_op'=>1, 'path' => '0', 'order' => 5, 'updated_op'=>1, 'params'=>'{"page_id": "13"}']);
    }
